...
const Page: React.FC = () => {
  ...
  return (
    <>
      <div className="bg-gray_50 flex flex-col font-cardo items-center justify-start mx-[auto] w-[100%]">
        <div className="md:h-[1120px] h-[1647px] md:px-[20px] relative w-[100%]">
          <div className="flex flex-col m-[auto] w-[100%]">
            <div className="bg-indigo_900 h-[527px] mx-[auto] w-[100%]"></div>
            <div className="md:h-[1120px] h-[1124px] mt-[-4px] mx-[auto] w-[100%] z-[1]">
              <Img
                src="images/img_photo_1124x1920.png"
                className="h-[1124px] m-[auto] object-cover w-[100%]"
                alt="Photo"
              />
              <div className="absolute flex flex-col gap-[35px] h-[max-content] inset-[0] items-center justify-start m-[auto] sm:w-[100%] w-[589px]">
                <Img
                  src="images/img_vector.svg"
                  className="h-[215px] w-[470px]"
                  alt="Vector"
                />
                <div className="flex flex-col gap-[41px] items-center justify-start sm:w-[100%] w-[589px]">
                  <div className="flex flex-col gap-[16px] items-center justify-start sm:w-[100%] w-[589px]">
                    <Text
                      className="font-cardo text-center text-indigo_900 tracking-[-0.80px] w-[auto]"
                      variant="body3"
                    >
                      Page not Found!!!
                    </Text>
                    <Text
                      className="font-inter font-normal leading-[170.00%] md:max-w-[100%] max-w-[589px] not-italic text-center text-gray_500 tracking-[-0.19px]"
                      variant="body14"
                    >
                      The page you are looking for doesn&#39;t exist. Please try
                      searching for some other page, or return to the
                      website&#39;s homepage to find what you&#39;re looking
                      for.
                    </Text>
                  </div>
                  <Button
          ...
          <div className="absolute flex font-inter inset-x-[0] items-center justify-start mx-[auto] top-[0] w-[100%]">
            <div className="h-[527px] relative w-[100%]">
              <div className="flex h-[100%] items-center justify-start m-[auto] w-[100%]">
                <div className="bg-indigo_900_b0 h-[527px] w-[100%]"></div>
              </div>
              <div className="absolute flex flex-col gap-[137px] md:gap-[40px] inset-x-[0] items-center justify-start mx-[auto] top-[7%] w-[68%]">
                ...
                <div className="flex flex-col gap-[28px] items-center justify-start max-w-[633px] w-[100%]">
                  <div className="flex flex-col font-cardo gap-[34px] items-center justify-start w-[234px]">
                    <Text
                    ...
                    <Line className="bg-amber_A200 h-[3px] w-[24%]" />
                  </div>
                  <Text
