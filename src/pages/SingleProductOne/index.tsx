...
const SingleProductOnePage: React.FC = () => {
  ...
  return (
    <>
      <div className="bg-white_A700 font-inter h-[2779px] mx-[auto] relative w-[100%]">
        <footer className="absolute bottom-[0] flex inset-x-[0] items-center justify-center mx-[auto] md:px-[20px] w-[100%]">
          <div
        ...
        <div
          className="absolute bg-cover bg-no-repeat bottom-[18%] flex h-[385px] inset-x-[0] items-center justify-start mx-[auto] p-[85px] sm:px-[20px] md:px-[40px] w-[100%]"
          style={{ backgroundImage: "url('images/img_features.svg')" }}
        >
          <List
            className="sm:flex-col flex-row md:gap-[40px] gap-[90px] grid sm:grid-cols-1 md:grid-cols-2 grid-cols-3 justify-center max-w-[1297px] w-[100%]"
        ...
        <div className="absolute flex flex-col gap-[120px] md:gap-[40px] inset-x-[0] items-center justify-start max-w-[1297px] mx-[auto] md:px-[20px] top-[24%] w-[100%]">
        ...
        <div className="h-[527px] mx-[auto] md:px-[20px] w-[100%]">
        ...
        <div className="absolute bg-indigo_900_a2 bottom-[0] font-cardo h-[4156px] md:h-[707px] sm:h-[746px] inset-x-[0] mx-[auto] p-[515px] md:px-[20px] w-[100%]">
          <div className="bg-white_A700 h-[707px] mx-[auto] rotate-[180deg] w-[42%]"></div>
          <div className="absolute flex flex-col md:gap-[40px] gap-[62px] h-[709px] md:h-[auto] inset-x-[0] items-center justify-center mx-[auto] top-[12%] w-[auto]">
            <div className="bg-amber_A200 flex items-center justify-center sm:px-[20px] md:px-[40px] px-[76px] py-[35px] rounded-bl-[0] rounded-br-[0] rounded-tl-[5px] rounded-tr-[5px] md:w-[100%] w-[auto]">
              <div className="flex flex-row sm:gap-[40px] items-center justify-between max-w-[647px] w-[100%]">
                <Text
                  className="text-indigo_900 text-left tracking-[-1.00px] w-[auto]"
                  as="h6"
                  variant="h6"
                >
                  Your Cart
            ...
            <div className="flex flex-col font-inter md:gap-[40px] gap-[65px] h-[517px] md:h-[auto] items-center justify-start max-w-[801px] w-[100%]">
              <div className="flex sm:flex-col flex-row sm:gap-[40px] items-start justify-between max-w-[647px] w-[100%]">
                <div className="flex flex-row gap-[38px] items-start justify-start w-[322px]">
                  <div className="bg-gray_53 border-[4px] border-gray_303 border-solid flex items-center justify-start w-[42%]">
                    <div
                      className="bg-cover bg-no-repeat flex h-[176px] items-center justify-start p-[5px] md:w-[100%] w-[98%]"
                      style={{
                        backgroundImage: "url('images/img_group7.svg')",
                      }}
                    >
                      <div className="flex flex-col items-center justify-start mb-[9px] md:w-[100%] w-[95%]">
                        <Img
                          src="images/img_name.svg"
                        ...
                        />
                        <Text
                          className="font-cardo italic leading-[6.00px] mt-[21px] text-center text-indigo_900 tracking-[-0.10px] sm:w-[100%] w-[84%]"
                          variant="body1"
                        >
                          A long established fact that a reader normal as well
                          distribution of letters
                        ...
                        <Img
                          src="images/img_trees.svg"
                          className="h-[36px] mt-[7px] w-[auto]"
                          alt="Trees One"
                        />
                        <Text
                          className="font-inter mt-[8px] text-center text-indigo_900 tracking-[0.40px] uppercase w-[auto]"
                          variant="body4"
                        >
                          JOHN ABRAHAM
                        </Text>
                        <Text
                          className="font-cardo italic text-center text-lime_700 tracking-[-0.10px] w-[auto]"
                          variant="body1"
                        >
                          A supreme packages and web page editors.
                        </Text>
                        <div className="font-inter h-[4px] relative w-[79%]">
                          <Text
                            className="m-[auto] text-center text-indigo_900 tracking-[0.63px] w-[auto]"
                            variant="body13"
                          >
                            ********************** **********************
                          </Text>
                          <div className="absolute bg-amber_A200 bottom-[0] h-[2px] inset-x-[0] mx-[auto] rounded-[50%] w-[2px]"></div>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="flex flex-col items-start justify-start w-[auto]">
                    ...
                    <Text
                      className="font-inter font-medium mt-[9px] text-gray_500 text-left tracking-[-0.20px] w-[auto]"
                      variant="body12"
                    >
                      $30.00 USD
                    </Text>
                    <Text
                      className="font-cardo font-normal mt-[56px] not-italic text-indigo_900 text-left tracking-[-0.35px] w-[auto]"
                      variant="body5"
                    >
                      Remove
                    </Text>
                ...
                <Text
                  className="bg-gray_57 border-[1px] border-gray_200 border-solid font-medium h-[62px] pl-[25px] pr-[35px] sm:px-[20px] py-[18px] text-gray_500 text-left tracking-[-0.20px] w-[120px]"
                  variant="body12"
                >
                  1
                </Text>
              </div>
              <div className="flex flex-col font-cardo md:gap-[40px] gap-[61px] items-center justify-start max-w-[801px] w-[100%]">
                <div className="flex flex-col gap-[24px] items-center justify-start w-[100%]">
                  <Line className="bg-indigo_900_6c h-[1px] w-[100%]" />
                  <div className="flex flex-row sm:gap-[40px] items-center justify-between max-w-[647px] w-[100%]">
                    <Text
                      className="font-cardo font-normal not-italic text-indigo_900 text-left tracking-[-0.24px] w-[auto]"
                      variant="body10"
                    >
                      Sub-Total
                    </Text>
                    <Text
                      className="font-bold font-inter text-indigo_900 text-left tracking-[-0.20px] w-[auto]"
                      variant="body12"
                    >
                      $ 60.00 USD
                    </Text>
                ...
                <Button
                  className="cursor-pointer font-bold md:min-w-[100%] min-w-[647px] text-[19px] text-center text-indigo_900 tracking-[0.38px] w-[auto]"
                  size="md"
                  variant="FillAmberA200"
                >
...
export default SingleProductOnePage;
