  ...
  return (
    <>
      <div className="bg-white_A700 flex flex-col font-inter items-center justify-start mx-[auto] w-[100%]">
        ...
        <div className="bg-gray_100 flex items-center justify-start mt-[200px] md:px-[20px] px-[89px] py-[53px] md:w-[100%] w-[600px]">
          <div className="flex flex-col gap-[20px] items-center justify-start sm:w-[100%] w-[422px]">
            <Text
              className="bg-amber_A200 flex font-cardo h-[90px] items-center justify-center sm:px-[20px] rounded-[50%] text-center text-indigo_900 tracking-[-0.45px] w-[90px]"
              variant="body7"
            >
              V.1
            </Text>
            <Text
              className="font-inter font-normal not-italic text-center text-gray_500 w-[auto]"
              variant="body14"
            >
              Initial Pages Webflow Template Release
            </Text>
          </div>
        </div>
        <footer className="flex items-center justify-center mt-[201px] md:px-[20px] w-[100%]">
          <div
